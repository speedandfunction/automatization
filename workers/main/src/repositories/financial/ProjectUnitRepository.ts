...
import { IProjectUnitRepository } from './IProjectUnitRepository';

export class ProjectUnitRepository implements IProjectUnitRepository {
  private pool: Pool;
  constructor() {
    this.pool = new RedminePool(redmineDatabaseConfig).getPool();
  }
